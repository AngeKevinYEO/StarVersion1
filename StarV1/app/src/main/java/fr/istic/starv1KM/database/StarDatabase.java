...
@Database(entities = {BusRoute.class, TripEntity.class, StopEntity.class, StopTimeEntity.class, CalendarEntity.class}, version = 2, exportSchema = false)
public abstract class StarDatabase extends RoomDatabase {

    public static final String DB_NAME = "star_km_db";
